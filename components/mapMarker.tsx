    ...
    <section className="bg-transparent my-5 pb-5 container">
      ...
      <div className="d-flex flex-column gap-3">
        <div className="d-flex flex-column justify-content-center align-items-start gap-1">
          <div>
            <img src="/icons/map-pin.svg" alt="" width={20} /> <span className="pe-1 font-semibold">Address:</span> <a className="route" title="Click to open Google Maps" href="https://maps.google.com/maps?ll=15.43992,75.012603&z=16&t=m&hl=en&gl=IN&mapclient=embed&cid=13843715858955862559">Jadhav Compound Saraswatpur Dharwad near last bus stop  580002</a>
          </div>
          <div>
            <img src="/icons/phone.svg" alt="" width={20} /> <span className="pe-3 font-semibold">Phone:</span> <a className="route" title="Click to call" href="phone:+918951003817">+918951003817</a>
          </div>
        </div>
